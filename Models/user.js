...
class User {
	constructor(ip, connectedIn, spotifyAcssesToken, spotifyID = 'notConnected', socketID = 'notConnected') {
		this.ip = ip;
	...
	async ConnectToSpotify() {
		...
		this.musicalTaste = this.GetGeneresFromArtists();
		return 'yessss';
	}
	...
	JoinRoom(roomName) {
		...
		this.socket.to(this.roomID).emit('enteredRoom');
	}
}
